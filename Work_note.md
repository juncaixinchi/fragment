...
实现通过云上传文件，修复bug，发布v1.1.19

### 20170928

实现微信登录但使用局域网传输文件，发布v1.1.20

### 20170929

修复测试发现的各种bug，发布v1.1.21

### 20170930

继续修复发现的bug，发布930版本，v1.2.0